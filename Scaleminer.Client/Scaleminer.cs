//Copyright Cody Popham, 2014, United States
//
//
...
namespace Scaleminer.Client
{
  public class ScaleminerClient : EnumScaleminerClient
  {
    public ScaleminerClient()
    { 
    }

    public ScaleminerClient(string a_sUri)
    {
      Url = new Uri(a_sUri);
    }
